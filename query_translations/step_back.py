...
generate_queries_step_back = prompt | ChatOpenAI(temperature=0, model="gpt-3.5-turbo-0125") | StrOutputParser()
question = "What is task decomposition for LLM agents?"
generated_queries = generate_queries_step_back.invoke({"question": question})
print("Generated Queries:", generated_queries)

# Response prompt
response_prompt_template = """You are an expert of world knowledge. I am going to ask you a question. Your response 
should be comprehensive and not contradicted with the following context if they are relevant. Otherwise, ignore them 
